...
class DetailPenjualanController extends Controller
{
    ...
    {
        $obat = Obat::get();
        return view('detail_penjualan.create', compact('id', 'obat'));
    }


    public function create($id)
    {
        return view('Penjualan_detail.create', compact('id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $Penjualan_detail = Penjualan_detail::create([
            'Penjualan_id' => $request->notaId,
